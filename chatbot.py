...
Keep responses concise and practical."""
    ...
    st.markdown("<h1>🔍 Web Search Agent</h1>", unsafe_allow_html=True)
    st.markdown("<p>Ask anything — I search the web for real time answers</p>", unsafe_allow_html=True)
    st.divider()
    ...
    search_input = st.chat_input("Ask me anything — I can search the web!")
    if search_input:
    ...
    st.markdown("<h1>📄 PDF Reader</h1>", unsafe_allow_html=True)
    st.markdown("<p>Upload a PDF and ask anything about it</p>", unsafe_allow_html=True)
    st.divider()
    ...
    pdf_input = st.chat_input("Ask anything about your PDF...")
    if pdf_input and pdf_text:
